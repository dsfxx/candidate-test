...
// Defined store route
ClientRoutes.route('/clientadd').post(function (req, res) {
...
// Defined edit route
ClientRoutes.route('/clientedit/:id').get(function (req, res) {
...
ClientRoutes.route('/clientupdate/:id').post(function (req, res) {
...
ClientRoutes.route('/clientdelete/:id').get(function (req, res) {
